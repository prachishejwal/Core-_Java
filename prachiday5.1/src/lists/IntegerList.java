package lists;
//arraylist:class interface:cant create instance
import java.util.ArrayList;
import java.util.Collections;
//non generic method contain generic
public class IntegerList {

	public static void main(String[] args) {
		// create empty AL to store Integer refs
		ArrayList<Integer> intList = new ArrayList<>();// size=0, capa :10(Defalut constru)growable typically depends on 
		...
		intList.add(0,i);//givres you in reverse mannaer
		...
		System.out.println(intList.indexOf(10) + " " + intList.lastIndexOf(107));//O(N)
		// double the values of all elems > 50
		for (int i = 0; i < intList.size(); i++)//index based==>forloop
			if (intList.get(i) > 50)// auto un boxing-->int-->Integer
...
//		Collection<E>
//
//ordeered cpllection ::index based opertion:indexOf :allows null
