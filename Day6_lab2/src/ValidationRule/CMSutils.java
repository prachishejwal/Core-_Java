...
import static .CustomerValidationRules.validateAllInputs;
...
//add a static method to return populated list of customers , with sample data
	public static List<Customer> populateList() throws CustomerHandlingException {
		...
		customers.add(
				validateAllInputs("Rama", "Kher", "rama@gmail.com", "12345", 1000, "1990-11-01", "silver", customers));
		customers.add(validateAllInputs("Shubham", "Vaidya", "shubham@gmail.com", "2345", 2000, "1997-11-21", "gold",
				customers));
		customers.add(validateAllInputs("Meera", "Savant", "meera@gmail.com", "2445", 5000, "1997-11-21", "diamond",
				customers));
		customers.add(
