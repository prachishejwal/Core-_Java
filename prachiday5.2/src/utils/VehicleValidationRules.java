...
//add a static method to parse n validate color
	...
	public static void checkForDuplicate(String newChasisNo, List<Vehicle> vehicles)
		...
		if (vehicles.contains(newVehicle))// arg:string-->so string equal get called (newChasisNo) give wronhg o/p,so we have argument parameter as newVehicle(of type vehicle)
