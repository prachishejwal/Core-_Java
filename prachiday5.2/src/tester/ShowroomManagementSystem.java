package tester;
//arraylist is array of reference
			...
			while (!exit) {
				...
				try {
					...
					case 1: // add a new vehicle
						//boundry checking not req its all depends on size
					...
					case 2:
						...
						break;
						//iterable is like foreach
					case 3:
						System.out.println("Enter chasis no");
						// showroom : [v1,v2,v3...v10....]//serching:pk
					...
					case 4://apply discount to old veichele//cant solve by indexof function due to non-primary key
					...
					case 6://contains,equalsof(internalls call equals method)
